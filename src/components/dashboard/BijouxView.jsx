  ...
  return (
    <>
      <div className="mb-[18px] mt-2">
        <h1 className="font-display text-[26px] font-bold tracking-tight">Bijoux</h1>
      ...
      <form onSubmit={handleSubmit}
        ...
        <Field label="Nom *"><input name="nom" value={form.nom} onChange={handleChange} required placeholder="Nom du bijou" className="w-full rounded-[11px] px-3 py-2.5 text-[13px]" style={inputStyle} /></Field>
        ...
        <div className="sm:col-span-2 lg:col-span-3">
          <Field label="Description"><textarea name="description" value={form.description} onChange={handleChange} placeholder="Détails du bijou..." className="w-full rounded-[11px] px-3 py-2.5 text-[13px] resize-vertical min-h-[70px]" style={inputStyle} /></Field>
        </div>
        <div className="sm:col-span-2 lg:col-span-3">
          <button type="submit" className="rounded-[11px] px-4 py-2.5 text-[13px] font-bold text-white"
            style={{ background: 'linear-gradient(120deg, #8B5CF6, #F472B6)' }}>Ajouter le bijou</button>
        </div>
      </form>
      )}
