...
export default function CategoriesView({ categories, onAdd, onDelete, canAdd, canDelete }) {
  ...
  return (
    <>
      <div className="mb-[18px] mt-2">
        <h1 className="font-display text-[26px] font-bold tracking-tight">Catégories</h1>
        <p className="text-[13.5px] mt-1" style={{ color: '#A79FB5' }}>Nomme tes catégories d'objets manuellement.</p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="rounded-[22px] p-[22px] mb-5 flex flex-col sm:flex-row gap-3 items-stretch sm:items-end"
        ...
        <div className="flex-1">
          ...
          <input value={nom} onChange={e => setNom(e.target.value)} placeholder="Ex : Moto, Pièce, Accessoire..."
